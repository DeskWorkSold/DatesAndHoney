...
const RelagionType = [
  {
    id: '1',
    name: 'Christian',
    onpress: 'MediatorQuestionMoreAboutChristianScreen'
  },
  {
    id: '2',
    name: 'Jewish',
    onpress: 'MediatorQuestionMoreAboutJewishScreen'
  },
  {
    id: '3',
    name: 'Catholic',
    onpress: 'MediatorQuestionMoreAboutCatholicScreen'
  },
  {
    id: '4',
    name: 'Muslim',
    onpress: 'MediatorQuestionMoreAboutMuslimScreen'
  },
  {
    id: '5',
    name: 'Hinduism',
...
const MediatorQuestionReligionScreen = ({ navigation, route }) => {
...
export default MediatorQuestionReligionScreen
