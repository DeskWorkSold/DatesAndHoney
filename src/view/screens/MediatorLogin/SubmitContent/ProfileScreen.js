...
const ProfileScreen = ({ navigation }) => {
    ...
    // console.log(mediator?.userDetails?.MediatorId);
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    {mediator?.userDetails?.MediatorId == 1 ?
                                        <Text style={{ color: COLORS.black, fontSize: 13 }}>Influencer</Text>
                                        :
