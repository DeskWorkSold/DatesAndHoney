...
const MediatorQuestionFavFoodScreen = ({ navigation, route }) => {
        ...
        <View style={styles.NumberInput}>
          <View style={{ flexDirection: 'row', alignItems: 'center', }}>
            ...
            <TextInput
              value={foodData}
              placeholder={'Search'}
              onChangeText={foodData => setFoodData(foodData)
              }
...
export default MediatorQuestionFavFoodScreen
