      ...
      <View style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={{
            ...
            <Text style={{
              color: COLORS.black
            }}>(Select all boxes that apply)</Text>
          </View>
...
export default MediatorQuestionBuildTypeScreen
