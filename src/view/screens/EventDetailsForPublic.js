...
const EventDetailsForPublic = ({ navigation, route }) => {
  const { eventId, promoCode } = route.params;
  // const eventId = '583c8995200bf'
  // const promoCode = 'FARf7um'
  console.log('public');
  ...
  const OnBuyTickets = () => {
    navigation.navigate('EventTickets', { details: { ...details, promoCode: promoCode }, Doc: null })
    return
    if (!showID.enable) {
...
export default EventDetailsForPublic
